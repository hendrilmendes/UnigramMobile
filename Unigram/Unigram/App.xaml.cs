...
namespace Unigram
{
    ...
    sealed partial class App : Template10.Common.BootStrapper
    {
        ...
        public App()
        {
            ...
            m_mediaExtensionManager.RegisterByteStreamHandler(
                "Unigram.Native.OpusByteStreamHandler", ".ogg", "audio/ogg");
        ...
        public override UIElement CreateRootElement(IActivatedEventArgs e)
        {
            ...
            INavigationService navigationService = NavigationServiceFactory(
                BackButton.Ignore, ExistingContent.Include, navigationFrame);
        ...
        private async void OnStartSync()
        {
            ...
            try
            {
                ...
                StorageFile localVoiceCommands = await Windows.Storage.StorageFile.GetFileFromApplicationUriAsync(new Uri("ms-appx:///VoiceCommands/VoiceCommands.xml"));
                await VoiceCommandDefinitionManager.InstallCommandDefinitionsFromStorageFileAsync(localVoiceCommands);
            }
            catch (Exception ex)
            {
                Debug.WriteLine("[ex] VoiceCommandDefinitionManager error: " + ex.Message);
            }
        }
        ...
        private void ColourTitleBar()
        {
            ...
            {
                Debug.WriteLine("Device does not have a Titlebar. Error message: " + ex.Message);
            }
        }
    }
